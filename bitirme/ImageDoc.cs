    ...
    public partial class ImageDoc : Content
    {
        ...
        public void Reload( )
        {
            if ( fileName != null )
            {
                ...
                {
                    throw new ApplicationException( "Tekrar yükleme baþarýsýz" );
                }
        ...
        private bool CheckIfColor( string filterName )
        {
            ...
            {
                MessageBox.Show( filterName + " Sadece RGB resimlere uygulanabilir.", "Message", MessageBoxButtons.OK, MessageBoxIcon.Exclamation );
                return false;
            }
            return true;
        }
        ...
        private bool CheckIfGrayscale( string filterName )
        {
            ...
            {
                MessageBox.Show( filterName + " Sadece gri görüntülere uygulanabilir.", "Uyarý", MessageBoxButtons.OK, MessageBoxIcon.Exclamation );
                return false;
            }
            return true;
        }
        ...
        private void ApplyFilter( IFilter filter )
        {
            if ( filter is IFilterInformation )
            {
                ...
                if ( !filterInfo.FormatTranslations.ContainsKey( image.PixelFormat ) )
                {
                    ...
                    {
                        MessageBox.Show( "Sadece renkli görüntülere uygulanabilir.", "Uyarý", MessageBoxButtons.OK, MessageBoxIcon.Error );
                    }
                    else
                    {
                        MessageBox.Show( "Sadece gri ve binary görüntülere uygulanabilir.\n\nGri görüntü kullanýnýz .", "Uyarý", MessageBoxButtons.OK, MessageBoxIcon.Error );
                    }
                    return;
                }
            }
            ...
            {
                MessageBox.Show("Seçilen filtreyi resme uygularken hata oluþtu\r\n\r\n" + ex.Message, "Uyarý", MessageBoxButtons.OK, MessageBoxIcon.Error );
            }
            finally
            {
                // restore cursor
        ...
        {
            Bitmap channelImage = host.GetImage( this, "Geçerli görüntüdeki kýrmýzý kanalý deðiþtirecek bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            Bitmap channelImage = host.GetImage( this, "Geçerli görüntüdeki yeþil kanalý deðiþtirecek bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            Bitmap channelImage = host.GetImage( this, "Geçerli görüntüdeki mavi kanalý deðiþtirecek bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            Bitmap channelImage = host.GetImage( this, "Geçerli resimde Y kanalýnýn yerini alacak bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            Bitmap channelImage = host.GetImage( this, "Geçerli görüntüdeki Cb kanalýný deðiþtirecek bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            Bitmap channelImage = host.GetImage( this, "Geçerli görüntüdeki Cr kanalýný deðiþtirecek bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            Bitmap overlayImage = host.GetImage( this, "Mevcut resimle birleþtirilecek bir görüntü seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            Bitmap overlayImage = host.GetImage( this, "Mevcut resimle kesiþecek bir resim seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            Bitmap overlayImage = host.GetImage( this, "Mevcut resme eklenecek bir resim seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            Bitmap overlayImage = host.GetImage( this, "Mevcut görüntüden çýkarmak için bir görüntü seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            Bitmap overlayImage = host.GetImage( this, "Mevcut resimle fark yaratmak için bir görüntü seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            Bitmap overlayImage = host.GetImage( this, "Mevcut resmin taþýnacaðý bir resim seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            // get overlay image
            Bitmap overlayImage = host.GetImage( this, "Mevcut resmin deðiþtirileceði bir resim seçin", new Size( width, height ), image.PixelFormat );
        ...
        {
            // get overlay image
            Bitmap maskImage = host.GetImage( this, "Maske olarak kullanýlacak bir görüntü seçin", new Size( width, height ), PixelFormat.Format8bppIndexed );
        ...
        {
            // get overlay image
            Bitmap overlayImage = host.GetImage( this, "Stereo anaglif için 'doðru' görüntü olarak kullanýlmasý gereken bir görüntü seçin.",
        ...
        private void documentAligningMenuItem_Click( object sender, EventArgs e )
        {
            ...
            {
                MessageBox.Show("Eðim açýsý belirlenemedi. Gerçekten taranmýþ bir belge mi?", "Uyarý",
        ...
        private void ForwardFourierTransformation( )
        {
            ...
            {
                MessageBox.Show("Fourier dönüþümü, geniþlik ve yüksekliði eþit görüntülere uygulanabilir.", "Uyarý", MessageBoxButtons.OK, MessageBoxIcon.Exclamation );
                return;
            }
